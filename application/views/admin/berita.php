<div id="bg-isi"><h2>Module Berita</h2><br />
...
echo "<tr bgcolor='$warna'><td>".$nomor."</td><td>".$b->judul_berita."</td><td>".$b->nama_kategori."</td><td>".$b->tanggal."</td><td><a href='".base_url()."admin/editberita/".$b->id_berita."' title='Edit'><img src='".base_url()."asset/admin/images/edit-icon.gif' border='0'></a></td>
<td><a href='".base_url()."admin/hapusberita/".$b->id_berita."' onClick=\"return confirm('Anda yakin ingin menghapus berita ini?')\" title='Hapus'><img src='".base_url()."asset/admin/images/hapus-icon.gif' border='0'></a></td></tr>";
$nomor++;
}
?>
</table>
