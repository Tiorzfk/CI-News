<div id="bg-isi"><h2>Module Edit Berita</h2><br />
...
<tr><td width="150" valign="top"></td><td width="10" valign="top"></td><td><img src="<?php echo base_url(); ?>asset/menu_utama/berita/<?php echo $gambar;  ?>" /></td></tr>
