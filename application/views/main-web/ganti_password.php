...
<form method="post" action="<?php echo base_url(); ?>menu_utama/updatepassword">
<table cellspacing="5">
<tr><td width="150"><h3>Username</h3></td><td width="10">:</td><td><input type="text" name="username" readonly="readonly" value="<?php echo $nim; ?>" class="textfield" size="30"></td></tr>
